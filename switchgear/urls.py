...
urlpatterns = [
                  ...
                  path('switchgear/<int:switchgear_id>/photos/', SwitchgearPhotosDetailView.as_view(),
                       name='switchgear_photos'),
                  ...
                  path('switchgear/parameters/', SwitchgearParametersListView.as_view(),
                       name='switchgear_parameters_list'),
                  path('switchgear/parameters/<int:pk>/', SwitchgearParametersDetailView.as_view(),
                       name='switchgear_parameters_detail'),
                  path('switchgear/parameters/add/', SwitchgearParametersCreateView.as_view(),
                       name='switchgear_parameters_add'),
                  ...
                  path('order/<int:client_id>/add/', OrderCreateViewPassingClient.as_view(),
                       name='order_add_client_pass'),
                  ...
                  path('switchgear/<int:switchgear_id>/guarantee_gen_doc/', automatic_guarantee,
                       name='switchgear_gen_doc_guarantee'),
