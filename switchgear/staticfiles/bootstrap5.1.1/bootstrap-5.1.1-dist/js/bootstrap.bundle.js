...
(function (global, factory) {
  ...
  function getOffsetParent(element) {
    ...
    if (offsetParent && (getNodeName(offsetParent) === 'html' || getNodeName(offsetParent) === 'body' && getComputedStyle$1(offsetParent).position === 'staticfiles')) {
      return window;
    }
  ...
  function mapToStyles(_ref2) {
    ...
    if (adaptive) {
      ...
      if (offsetParent === getWindow(popper)) {
        ...
        if (getComputedStyle$1(offsetParent).position !== 'staticfiles' && position === 'absolute') {
